...
public class GrowActivity extends Activity implements OnItemClickListener {
    ...
    private ImageView growImageView01;
    private ImageView growImageView02;
    private ImageView growImageView03;
    private ImageView growImageView04;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitleView.setText("生长监测");
        growImageView01 = (ImageView) findViewById(R.id.growImageView01);
        growImageView02 = (ImageView) findViewById(R.id.growImageView02);
        growImageView03 = (ImageView) findViewById(R.id.growImageView03);
        growImageView04 = (ImageView) findViewById(R.id.growImageView04);
...
//                imageButton = (ImageButton) findViewById(R.id.ImageButtonLeftBottom);
        ...
        growImageView01.setOnClickListener(ImageViewClickListener01);
...
//                imageButton = (ImageButton) findViewById(R.id.ImageButtonLeftBottom);
        ...
        growImageView02.setOnClickListener(ImageViewClickListener02);
...
//                imageButton = (ImageButton) findViewById(R.id.ImageButtonLeftBottom);
        ...
        growImageView03.setOnClickListener(ImageViewClickListener03);
...
//                imageButton = (ImageButton) findViewById(R.id.ImageButtonLeftBottom);
        ...
        growImageView04.setOnClickListener(ImageViewClickListener04);
...
//                            UploadUtil.uploadFile(file4, "http://pic.giscloud.ac.cn");
                ...
                Toast.makeText(GrowActivity.this, "已发送",
    ...
    private void showProgressDialog() {
        dialog = new ProgressDialog(GrowActivity.this);
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            MyToast.showToast(GrowActivity.this, "上传成功");
        }
    };
    ...
    public void InsertToDatabaseService(String ID, String area, String count,
        ...
        try {
            ...
            // 创建提示框提醒是否登录成功
            AlertDialog.Builder builder = new AlertDialog.Builder(GrowActivity.this);
            builder.setTitle("提示")
                    .setMessage(result)
...
//                    break;
                case CROPPHOTO:
                    ...
                    growImageView01.setImageBitmap(bm);
                    break;
                    ...
                    try {
                        if (resultCode == RESULT_OK) {
                            ...
                            if (clickedImageViewNumber == 1) {
                                growImageView01.setImageBitmap(bitmap);
                            } else if (clickedImageViewNumber == 2) {
                                growImageView02.setImageBitmap(bitmap);
                            } else if (clickedImageViewNumber == 3) {
                                growImageView03.setImageBitmap(bitmap);
                            } else if (clickedImageViewNumber == 4) {
                                growImageView04.setImageBitmap(bitmap);
                            }
...
//        Toast.makeText(this, "准备启动相机", Toast.LENGTH_LONG).show();
        ...
        if (ActivityCompat.checkSelfPermission(GrowActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
//            Toast.makeText(this, "请开启应用拍照权限", Toast.LENGTH_LONG).show();
            ActivityCompat.requestPermissions(GrowActivity.this, new String[]{Manifest.permission.CAMERA}, 1);
        }
        if (ActivityCompat.checkSelfPermission(GrowActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
...
//            ActivityCompat.requestPermissions(TransplantActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},140);
        ...
        if (PackageManager.PERMISSION_GRANTED == ActivityCompat.checkSelfPermission(GrowActivity.this, Manifest.permission.CAMERA)) {
...
//            startActivityForResult(intent, CAPTURE_PIC);// 启动系统相机,等待返回
            ...
            requestRuntimePermission(permissions, new PermissionListener() {
                ...
                public void onDenied(List<String> deniedPermission) {
                    Toast.makeText(GrowActivity.this, deniedPermission.toString() + "权限被拒绝", Toast.LENGTH_LONG).show();
                    //有权限被拒绝，什么也不做好了，看你心情
                }
            });
...
//            Toast.makeText(this, "请开启应用拍照权限", Toast.LENGTH_LONG).show();
            int RESULT_CODE_STARTCAMERA = 1;
            String[] perms = {"android.permission.CAMERA"};
            ActivityCompat.requestPermissions(GrowActivity.this, perms, RESULT_CODE_STARTCAMERA);
        }
...
//        startActivityForResult(intent, CAPTURE_PIC);// 启动系统相机,等待返回
    ...
    public void requestRuntimePermission(String[] permissions, PermissionListener listener) {
        ...
        for (String permission : permissions) {
            if (ContextCompat.checkSelfPermission(GrowActivity.this, permission)
                    != PackageManager.PERMISSION_GRANTED) {
                permissionList.add(permission);
            }
        }
        if (!permissionList.isEmpty()) {
            ActivityCompat.requestPermissions(GrowActivity.this,
...
//        mPath = FileUtils.getStorageDirectory() + mUUID;
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            imageUri = FileProvider.getUriForFile(GrowActivity.this, fileprovider,
                    cameraFile);
        }
        // 启动相机程序
